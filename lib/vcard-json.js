...
attributes.UtfFullNaem = "FN;CHARSET=UTF-8;ENCODING=QUOTED-PRINTABLE:";
...
function attributeMatched(attribute, line, contact) {
  switch (attribute) {
    ...
    case "FN;CHARSET=UTF-8;ENCODING=QUOTED-PRINTABLE:":
      contact.fullname = mimelib.decodeQuotedPrintable(
        s(line.slice(42)).clean().value()
      );
      break;
